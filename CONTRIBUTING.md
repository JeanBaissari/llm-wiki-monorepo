...
6. Add to `INDEX.md` scripts table
7. Add to `QUICKGUIDE.md` with examples
...
4. Add it to `INDEX.md` template table
...
PRs that change behavior should include or update tests. PRs that add scripts should update documentation (INDEX.md, QUICKGUIDE.md).
