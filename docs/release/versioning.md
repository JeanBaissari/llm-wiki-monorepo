...
The llm-wiki-monorepo Python package is at **0.6.1** (PyPI: `baissarienterprises-llm-wiki`).

| Milestone | Description |
|-----------|-------------|
| v0.6.1    | v0.6.0 documentation cleanup — repo-state docs (USAGE.md, AGENTS.md, SKILL.md, file-map, quickstart, install.sh, README) aligned to the shipped 27 CLI / 15 MCP tool state |
