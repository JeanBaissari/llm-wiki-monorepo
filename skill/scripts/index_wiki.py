...
Usage:
    python3 index_wiki.py <wiki-root>               # incremental update
    python3 index_wiki.py <wiki-root> --rebuild     # full rebuild
    python3 index_wiki.py <wiki-root> --json        # JSON output
...
# ── Import discover.py from sibling scripts directory ────────────────────
