...
# Guard against skill/scripts/logging.py shadowing stdlib logging.
# portalocker internally imports stdlib logging.getLogger — ensure the real
# module is loaded before portalocker resolves it through sys.path.
_paths_to_skip = {p for p in _sys.path if "skill/scripts" in p}
_saved_path = list(_sys.path)
_sys.path = [p for p in _sys.path if p not in _paths_to_skip]
try:
